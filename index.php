    ...
    <body>
        <div id="wrap">
            <header>
                <div class="inside">
                    <nav>
<center><h1> Tests with htaccess</h1></center>
                    </nav>
                </div>
            </header>
            <article>
                <section>
                    <div class="inside">
                <a href="nana.html"> Test <code>'nana.html'</code> url</a> <br/>
		<a href="protected/">Go to protected Folder </a> <br/>
		<a href="falseasp.david"> Goto False asp </a>
                </section>  
            </article>
            <aside>
                <div class="inside">
        ...
        <footer>
            <div class="inside">
			<a href="http://www.besthostratings.com/articles/block-users-by-ip.html">.htaccess tutorial/easy library/Resource </a>
            </div>
        </footer>        
        <script type="text/javascript" src="js/custom.js"></script>
        <script type="text/javascript" src="fonts/Lobster.font.js"></script>
        <script type="text/javascript" src="fonts/Raleway.font.js"></script> 
    </body>
</html>
